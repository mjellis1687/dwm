...
- [restoreafterstart](https://dwm.suckless.org/patches/restoreafterrestart/) via [patch](https://dwm.suckless.org/patches/restoreafterrestart/dwm-restoreafterrestart-20220709-d3f93c7.diff): Save tag of every window/client to the file and after dwm is restarted the file is read and used to get all the windows/clients in their previous tags.
- [restartsig](https://dwm.suckless.org/patches/restartsig/) via [patch](https://dwm.suckless.org/patches/restartsig/dwm-restartsig-20180523-6.2.diff): Enable dwm to be restarted via MOD+CTRL+SHIFT+Q or by kill -HUP dwmpid (required for restart after start).
